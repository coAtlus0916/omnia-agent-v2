...
- 便携包：[Omnia-Agent-v5-Remote-Connector-v0.1.0-Portable.zip](https://download.example.invalid/files/v5-remote-connector/releases/0.1.0/Omnia-Agent-v5-Remote-Connector-v0.1.0-Portable.zip)
- 稳定更新清单：[stable.json](https://download.example.invalid/files/v5-remote-connector/stable.json)
- 版本：`0.1.0`
- 发布序列：`1`
- 大小：`34,120,577 bytes`
...
- ZIP：`https://download.example.invalid/files/v5-remote-connector/releases/0.2.0/Omnia-Agent-v5-Remote-Connector-v0.2.0-Portable.zip`
