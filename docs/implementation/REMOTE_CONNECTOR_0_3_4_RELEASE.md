...
- ZIP：`https://download.labcaspian.com/files/v5-remote-connector/releases/0.3.4/Omnia-Agent-v5-Remote-Connector-v0.3.4-Portable.zip`
- Bridge：`https://agent.labcaspian.com/v5-bridge/`
