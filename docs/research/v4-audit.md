...
- AI Provider 被服务端固定为 DeepSeek：URL 为 `https://provider.example.invalid`，模型为 `deepseek-v4-flash`；设置页和 API 只接受 API Key，明确拒绝用户选择 Base URL/模型；`src/ai-provider.js:1-10`、`src/server.js:1420-1430`、`src/db.js:2561-2569`、`public/app.js:3910-3937`、`tests/managed-ai-config.test.js:22-38`。
