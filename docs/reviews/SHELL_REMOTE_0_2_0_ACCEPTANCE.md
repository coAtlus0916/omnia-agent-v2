...
- 公网 `https://agent.example.invalid/v5-bridge/`；
...
- ZIP：
  `https://download.example.invalid/files/v5-remote-connector/releases/0.2.0/Omnia-Agent-v5-Remote-Connector-v0.2.0-Portable.zip`；
- `37,282,502` bytes；
- SHA-256：
