...
Version 0.2.40, sequence 42. Cross-Run remote target reservations are derived from Workspace-bound object/GRA business identities and their field or relation IDs, never from template row position alone. User-workbook OOXML parsing remains namespace-prefix neutral and fail-closed.
