...
Version 0.2.27, sequence 29. The Feature retains all prior identity, subtype, authority, safety and receipt contracts. An existing incomplete GRA now freezes stable governed targets by relation/item identity while deferring generated catalog IDs until after the exact status and RAIT patches. Existing GRAs already at the target state still receive full prepare-time live validation.
