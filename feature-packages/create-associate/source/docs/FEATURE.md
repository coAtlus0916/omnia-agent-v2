...
Version 0.2.38, sequence 40. The Feature retains all prior identity, authority, safety, ordering and receipt contracts. Documentation write/readback now uses the v4-recorded RTE string and live assessment concurrency contract, and Evaluation submit sends the recorded null override. Runtime input cannot supply concurrency IDs or timestamps.
