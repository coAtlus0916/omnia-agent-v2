...
const CAPABILITIES = Object.freeze(['select_hidden_tab_controls', 'build_hidden_tab_plan', 'classify_control_observation', 'build_phase2_workbook', 'parse_uploaded_workbook', 'build_phase2_template', 'apply_replacement_fields', 'extract_policy_archive', 'build_policy_index', 'retrieve_policy_snippets', 'extract_placeholders', 'reconcile_writeback_controls']);
