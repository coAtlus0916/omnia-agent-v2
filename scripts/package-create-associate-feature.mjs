...
const pendingRecordingContentValues = Object.freeze({
  ...
  OS: Object.freeze([{ inputValue: 'AD', expectedOmniaContentName: '', status: 'blocked_pending_recording' }]),
  TOOL: Object.freeze([{ inputValue: '代码迁移工具', expectedOmniaContentName: '', status: 'blocked_pending_recording' }])
});
...
const version = '0.2.103'; const sequence = 105;
...
const runtimeContract={schemaVersion:'omnia.feature-runtime-contract/v1',featureId:'omnia.create-associate',featureVersion:version,
  ...
  storePorts:['createRun','readArtifactBytes','readManagedAssetBytes','commitArtifact','transitionRun','recordFieldRevisions','recordIssues','loadRunReview','commitReviewValidation','returnRunToReview','restartRun','inspectLegacyReturnRecovery','authorizeLegacyReturnRecovery','recordLegacyReturnRecoveryOutcome','closeLegacyPartialReturn','proveOwnedCreatedObject','prepareReturnIntent','approveReturnIntent','prepareReturnCommand','freezeReturnEvidenceSpec','recordReturnEvidence','projectVerifiedReturn','recordBootstrapCapabilityEvidence','getCapabilityEvidenceState','finishReturn','savePlan','loadPlan','openPythonArtifactHandle','createPythonJsonInputHandle','createPythonOutputHandle','readPythonJsonHandle','commitPythonOutputHandle','releasePythonArtifactHandles'],
...
for (const requiredPath of ['python/plan_ir.py','python/engine.py','middle/python-bridge.cjs','middle/worker.cjs','backend/Phase1-用户填写模板V5.xlsx','tests/manifest.json','tests/vectors.json','tests/self-test.cjs']) {
