...
const version = '0.2.150'; const sequence = 152;
...
const runtimeContract={schemaVersion:'omnia.feature-runtime-contract/v1',featureId:'omnia.create-associate',featureVersion:version,
  ...
  storePorts:[
    ...
    'loadReturnReconcileSpec','openPythonArtifactHandle','prepareReturnCommand','bindMutationReservationEvidence','prepareReturnIntent',
