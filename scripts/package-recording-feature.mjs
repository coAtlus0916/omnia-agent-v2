...
const pythonMemberPaths = ['python/engine.py', 'python/export.py', 'python/gra_catalog.py', 'python/protocol.py', 'python/recording_store.py'];
...
const runtimeContract = {
  ...
  storePorts: [
    ...
    'compareAndSwapPlan', 'savePlan', 'loadPlan'
  ],
  pythonSidecar: {
    schemaVersion: 'omnia.python-sidecar-runtime/v1', implementation: 'cpython', version: '3.13.14', architecture: 'win32-x64',
    protocol: 'omnia.python-sidecar-rpc/v1', bridgePath: 'middle/python-bridge.cjs', entryPath: 'python/engine.py',
...
const implementationMap = {
  ...
  planes: {
    ...
    worker: ['middle/worker.cjs', 'middle/python-bridge.cjs', ...pythonMemberPaths],
