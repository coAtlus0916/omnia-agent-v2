...
const defaultRemoteBridgeUrl = () => process.env.OMNIA_V5_REMOTE_BRIDGE_URL || 'https://agent.example.invalid/v5-bridge/';
...
export class CoreDatabase {
  ...
  private migrate(): void {
    ...
    const migrations: Array<[number, string]> = [
      ...
      [18, `
        ...
        SET base_url='https://provider.example.invalid', model='deepseek-v4-flash',
        ...
        WHERE singleton=1 AND provider='deepseek' AND model='deepseek-chat'
          AND base_url IN ('https://provider.example.invalid/v1/','https://provider.example.invalid/v1','https://provider.example.invalid/');
      `],
      [19, `
  ...
  private ensureDefaults(): void {
    ...
    this.db.prepare(`
      ...
      ) VALUES(1, 'deepseek', 'https://provider.example.invalid', 'deepseek-v4-flash', 'text_only', '', 1, 'untested', '', '', ?)
    `).run(now);
    this.db.prepare(`
