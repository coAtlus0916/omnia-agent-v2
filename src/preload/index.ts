...
const api: ShellApi = {
  ...
  saveFeatureVersionVisibility: (input) => invoke('shell:save-feature-version-visibility', input),
  generateTodayLogs: () => invoke('shell:generate-today-logs'),
  downloadLogExport: (input) => invoke('shell:download-log-export', input),
