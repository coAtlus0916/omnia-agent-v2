...
export const BRIDGE_VERSION = '0.4.8' as const;
...
export const DEFAULT_V5_BRIDGE_URL = 'https://agent.example.invalid/v5-bridge/' as const;
...
export interface BridgeUpdateCheckEnvelope {
  schemaVersion: typeof BRIDGE_SCHEMA;
  kind: 'update_check';
  requestedAt: string;
}
